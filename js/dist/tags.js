            ...
            case 6:
              ...
              actions = _this3.actions.map(function (_, i) {
                return {
                  ...
                  medias: getActionProperty('medias', i).split(',').map(function (s) {
                    return s.trim();
                  }),
...
riot.tag2('x-ribbon', '<div class="ribbon" title="Cette action est en partenariat avec les organismes suivants : {this.text}"> <span ref="content"><yield></yield></span> </div>', 'x-ribbon .ribbon,[data-is="x-ribbon"] .ribbon{ position: absolute; right: -5px; top: -5px; z-index: 1; overflow: hidden; width: 75px; height: 75px; text-align: right; cursor: help; } x-ribbon .ribbon span,[data-is="x-ribbon"] .ribbon span{ font-size: 10px; font-weight: bold; color: #FFF; text-transform: uppercase; text-align: center; line-height: 20px; transform: rotate(45deg); -webkit-transform: rotate(45deg); width: 100px; display: block; background: #79A70A; background: linear-gradient(#9BC90D 0%, #79A70A 100%); box-shadow: 0 3px 10px -5px rgba(0, 0, 0, 1); position: absolute; top: 19px; right: -21px; } x-ribbon .ribbon span::before,[data-is="x-ribbon"] .ribbon span::before{ content: ""; position: absolute; left: 0px; top: 100%; z-index: -1; border-left: 3px solid #79A70A; border-right: 3px solid transparent; border-bottom: 3px solid transparent; border-top: 3px solid #79A70A; } x-ribbon .ribbon span::after,[data-is="x-ribbon"] .ribbon span::after{ content: ""; position: absolute; right: 0px; top: 100%; z-index: -1; border-left: 3px solid transparent; border-right: 3px solid #79A70A; border-bottom: 3px solid transparent; border-top: 3px solid #79A70A; }', '', function (opts) {
  var _this11 = this;

  this.on('mount', function () {
    _this11.root.parentNode.classList.add('x-ribbon_parent');
    _this11.text = _this11.refs.content.textContent;
  });
});